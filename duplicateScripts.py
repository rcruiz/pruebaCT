...
class DuplicateScripts():
    ...
    def finalize(self, filename):
        ...
        result2 = self.total_duplicate
        #With dictionaries
        #dict_duplicate_names = {"Duplicate Scripts": self.list_duplicate, "Number of duplicate scripts": self.total_duplicate} # Add for me
        #duplicate_scripts = list((filename, self.list_duplicate, self.total_duplicate))
        #print(*[item for item in duplicate_scripts], sep=',')
        return result2
...
def main(filename):
    ...
    return duplicate.finalize(filename)
